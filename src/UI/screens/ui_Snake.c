...
static int sx[300],sy[300],len,dx,dy,fx,fy,score,over,hi,paused;
...
void ui_Snake_screen_init(void){
    ...
    lv_obj_add_event_cb(ui_Snake,gest,LV_EVENT_GESTURE,NULL);
